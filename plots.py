...
import numpy as np
path="/home/swt/Programme/ossec/benchmarks"

files = [f for f in listdir(path) if "txt" in str(f)]
files = sorted(files)
encr = {32:[], 64:[], 128:[], 256:[], 512:[], 1024:[], 2048:[], 4096:[]}
decr = {32:[], 64:[], 128:[], 256:[], 512:[], 1024:[], 2048:[], 4096:[]}
mem = {32:[], 64:[], 128:[], 256:[], 512:[], 1024:[], 2048:[], 4096:[]}
